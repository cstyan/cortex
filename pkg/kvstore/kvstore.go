...
// func NewKVStore(storeType string, cfg ConsulConfig) (KVClient, error) {
// 	if cfg.Mock != nil {
// 		return cfg.Mock, nil
// 	}
...
// 		// return NewConsulClient(cfg, codec)
// 	case "inmemory":
...
// 	default:
// 		return nil, fmt.Errorf("invalid KV store type: %s", storeType)
// 	}
